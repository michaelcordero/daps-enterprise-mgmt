...
object TempsTable: Table() {
    ...
    val daps_start = datetime("DAPSstart").nullable()
    ...
    val license_date = datetime("LicDate").nullable()
    val malp_ins = bool("MALPins?").nullable()
    val mapl_info = text("MAPLinfo").nullable()
    val exper_since = datetime("ExperSince").nullable()
    ...
    val account_rep_enddate = datetime("AccountRepEndDate").nullable()
    ...
    val resident_alien_exp = datetime("Resident Alien Exp").nullable()
