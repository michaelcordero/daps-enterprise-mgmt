<#-- @ftlvariable name="wrp" type="routes.web.WebResetPassword" -->
<#-- @ftlvariable name="validator" type="presenters.WebResetPasswordPresenter.Validator" -->
<#-- @ftlvariable name="presenter" type="presenters.WebResetPasswordPresenter" -->
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
                <div class="d-table-cell align-middle">
                    ...
                    <div class="text-center mt-4">
                        ...
                        <#if wrp.error??>
                            <p class="error" style="color: indianred">${wrp.error}</p>
                        </#if>
                    </div>
