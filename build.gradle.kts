...
dependencies {
    // KTOR
    implementation("io.ktor:ktor-server-content-negotiation-jvm:$ktor_tools_version")
    implementation("io.ktor:ktor-serialization-kotlinx-json:$ktor_tools_version")
    implementation("io.ktor:ktor-serialization-jackson:$ktor_tools_version")
    implementation("io.ktor:ktor-server-websockets:$ktor_tools_version")
    implementation("io.ktor:ktor-server-auth-jwt:$ktor_tools_version")
    implementation("io.ktor:ktor-server-netty:$ktor_tools_version")
//    implementation("io.ktor:ktor-server-core:$ktor_tools_version")
    implementation("io.ktor:ktor-server-status-pages:$ktor_tools_version")
    implementation("io.ktor:ktor-server-partial-content:$ktor_tools_version")
    implementation("io.ktor:ktor-server-conditional-headers:$ktor_tools_version")
    implementation("io.ktor:ktor-server-caching-headers:$ktor_tools_version")
    implementation("io.ktor:ktor-server-default-headers:$ktor_tools_version")
    implementation("io.ktor:ktor-server-html-builder:$ktor_tools_version")
    implementation("io.ktor:ktor-server-locations:$ktor_tools_version")
    implementation("io.ktor:ktor-server-freemarker:$ktor_tools_version")
    implementation("io.ktor:ktor-server-webjars:$ktor_tools_version")
    implementation("io.ktor:ktor-server-call-logging:$ktor_tools_version")
    // Exposed
